    ...
    while True:
        ...
        if ids is not None and len(ids) > 0:
            ...
            if result > 3:
                ...
                # print(f"位姿估计是否成功: {valid if 'valid' in locals() else False}")
        ...
        #print(f"Detected ArUco markers: {len(ids) if ids is not None else 0}")
        #print(f"Detected CharUco corners: {result if result > 0 else 0}")
