...
from dataset.lerobot.logging_compat import get_logger
...
reader_mod.logger_mp.setLevel(logging.ERROR)
...
logger_mp = get_logger(__name__, level=logging.INFO)
...
if __name__ == "__main__":
    ...
    data_dir = "dataset/data/0402_duo_unitree_pick_bread_87ep"
    start_episode = 34
    end_episode = 94
    fps = 60
    skip_step_nums = 4
