...
class UmiReplay:
    ...
    # Setup paths
        ...
        log.info(f"{self._task_data_dir}")
...
if __name__ == "__main__":
    ...
    arguments = {
        "config": {
            ...
            "type": str,
            # 指向你的配置文件
            "default": "factory/tasks/data_replay_config/right_umi_fr3_data_replay_cfg.yaml", 
