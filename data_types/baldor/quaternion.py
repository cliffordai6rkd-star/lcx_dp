...
import numpy as np
# Local modules
import data_types.baldor as br
from data_types.baldor import constants
...
def to_axis_angle(quaternion, identity_thresh=None):
  ...
  if identity_thresh is None:
    try:
      ...
      identity_thresh = constants._FLOAT_EPS * 3
  if Nq < constants._FLOAT_EPS ** 2:  # Results unreliable after normalization
